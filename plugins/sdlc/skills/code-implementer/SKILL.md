...
above — do not conflate them. Full list with ❌/✅ and the allowlist (`TODO`,
`SAFETY:`, security-why): `functional-clarity:functional-clarity` →
`references/05-comment-style.md`.
