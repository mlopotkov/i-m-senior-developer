...
Помогает писать простой, надёжный и понятный код, а существующий менять без лишнего риска. Полный свод — 22 принципа с отдельным 2A, стиль программирования, семишаговая дисциплина изменения существующего кода и отдельный скилл о комментариях «объясняй почему, а не что». При старте сессии агент получает выжимку принципов и краткое правило, которое обязан проверить перед каждой правкой комментариев; подагент получает то же правило при запуске.
